...
//import com.springboot.demo.auth.entity.vo.MenuTreeNode;
//import com.springboot.demo.auth.entity.vo.Message;
//import com.springboot.demo.auth.service.ResourceService;
//import com.springboot.demo.common.utils.TreeUtil;
...
//        } else {
//            return new Message().failed(1111, "add menu fail");
//        }
//    }
//
...
//        } else {
//            return new Message().failed(1111, "update menu fail");
//        }
//    }
//
...
//        } else {
//            return new Message().failed(1111, "delete menu fail");
//        }
//    }
//
...
//        } else {
//            return new Message().failed(1111, "add api fail");
//        }
//    }
//
...
//        } else {
//            return new Message().failed(1111, "update api fail");
//        }
//    }
//
...
//        } else {
//            return new Message().failed(1111, "delete api fail");
//        }
//    }
//
//}
